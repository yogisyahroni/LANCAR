...
export function WalletFeesPanel({ data }: { data: SettingsData }) {
  ...
  return (
    <>              <motion.div 
                ...
                exit={{ opacity: 0, y: -10 }}
                className="glass-card p-10 rounded-[48px] border-border space-y-12"
              >
                {/* Withdrawal Fees */}
                <div className="space-y-8">
                  <h3 className="text-xl font-black text-foreground-muted flex items-center gap-3 tracking-tight">
                    <DollarSign className="text-primary-light" size={24} aria-hidden="true" />
                    Withdrawal Fees
                  </h3>
                ...
                <div className="pt-12 border-t border-border space-y-8">
                  <h3 className="text-xl font-black text-foreground-muted flex items-center gap-3 tracking-tight">
                    <Zap className="text-primary-light" size={24} aria-hidden="true" />
                    Top-Up & Service Fees
                  </h3>
                ...
                <div className="pt-12 border-t border-border space-y-8">
                  <h3 className="text-xl font-black text-foreground-muted flex items-center gap-3 tracking-tight">
                    <Shield className="text-primary-light" size={24} aria-hidden="true" />
