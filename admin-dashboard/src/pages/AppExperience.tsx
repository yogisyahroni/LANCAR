...
export default function AppExperience() {
  ...
  useEffect(() => {
    ...
    setPreviewAudience({ market_code: editorManifest.market_code, locale: editorManifest.locale, app_version: editorManifest.min_app_version, cohort: '' })
