              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="mt-6 flex justify-end gap-3 pt-4 border-t border-border">
                  ...
                  <button
                    ...
                    className="rounded-md border border-transparent bg-info px-4 py-2 text-sm font-medium text-on-info shadow-sm hover:bg-info focus:outline-none focus:ring-2 focus:ring-info focus:ring-offset-2 disabled:opacity-50"
                  >
