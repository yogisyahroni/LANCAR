...
export default function Finance() {
  ...
  return (
    <FinanceContent
      COLORS={COLORS}
      activePayoutStatuses={activePayoutStatuses}
      payoutStatusLabel={payoutStatusLabel}
      riskActionLabel={riskActionLabel}
      serviceLabel={serviceLabel}
      closingPeriod={closingPeriod}
      closingPeriods={closingPeriods}
      closingSettlementOutstanding={closingSettlementOutstanding}
      closingTaxSummary={closingTaxSummary}
      cashPosition={cashPosition}
      closingCashLiability={closingCashLiability}
      courierEscrow={courierEscrow}
      emergencyFund={emergencyFund}
      reconciliationSummary={reconciliationSummary}
      latestReconItems={latestReconItems}
      ...
      totalTrx={totalTrx}
      totalCompanyDeductions={totalCompanyDeductions}
      totalInfra={totalInfra}
      totalReserve={totalReserve}
      totalSalary={totalSalary}
      simInfraCost={simInfraCost}
      simReserveCost={simReserveCost}
      simSalaryCost={simSalaryCost}
      stats={stats}
      payouts={payouts}
      payoutAccounts={payoutAccounts}
      payoutOps={payoutOps}
      payoutRequests={payoutRequests}
      payoutReviewQueue={payoutReviewQueue}
      payoutReviewDetail={payoutReviewDetail}
      ...
      ledgerJournalTypeFilter={ledgerJournalTypeFilter}
      ledgerStartDate={ledgerStartDate}
      pnlPeriod={pnlPeriod}
      pnlReport={pnlReport}
      pphPeriod={pphPeriod}
      pphReport={pphReport}
      pphBadan22={pphBadan22}
      taxDashboard={taxDashboard}
      trialBalanceData={trialBalanceData}
      unitEconomicsData={unitEconomicsData}
      serviceSettlementRows={serviceSettlementRows}
      history={history}
      confirmModal={confirmModal}
      totpInput={totpInput}
      activeTab={activeTab}
      formatCurrency={formatCurrency}
      isLoadingCashLiability={isLoadingCashLiability}
      isLoadingLedgerEntries={isLoadingLedgerEntries}
      isLoadingPeriods={isLoadingPeriods}
      isLoadingPnl={isLoadingPnl}
      isLoadingPph={isLoadingPph}
      isLoadingRecon={isLoadingRecon}
      isLoadingServiceSettlement={isLoadingServiceSettlement}
      isLoadingSettlementOutstanding={isLoadingSettlementOutstanding}
      isLoadingTax={isLoadingTax}
      isLoadingTaxSummary={isLoadingTaxSummary}
      isLoadingTrialBalance={isLoadingTrialBalance}
      isLoadingUnitEconomics={isLoadingUnitEconomics}
      batchReleaseMutation={batchReleaseMutation}
      dispatchApprovedPayoutsMutation={dispatchApprovedPayoutsMutation}
      lockPeriodMutation={lockPeriodMutation}
      releaseMutation={releaseMutation}
      reconcilePayoutsMutation={reconcilePayoutsMutation}
      runReconciliationMutation={runReconciliationMutation}
      topUpMutation={topUpMutation}
      updatePayoutAccountMutation={updatePayoutAccountMutation}
      updatePayoutRequestMutation={updatePayoutRequestMutation}
      payoutReviewActionMutation={payoutReviewActionMutation}
      handleExportEfaktur={handleExportEfaktur}
      handleExportPPh23={handleExportPPh23}
