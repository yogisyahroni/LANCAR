  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-surface-subtle backdrop-blur-sm animate-in fade-in duration-200 overflow-y-auto">
      ...
      <motion.div 
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="admin-payment-link-form-title"
        onKeyDown={(event) => {
      ...
      >
        <div className="p-10 space-y-8">
          <div className="flex items-center justify-between">
            <div>
              <h2 id="admin-payment-link-form-title" className="text-2xl font-black text-foreground-muted italic uppercase tracking-tight">
                Generate Payment Link
              </h2>
              <p className="text-foreground-muted text-xs mt-1 font-medium">Create a new invoice for your customer.</p>
            </div>
            <button type="button" onClick={onClose} aria-label="Tutup detail tautan pembayaran" title="Tutup detail tautan pembayaran" className="p-3 rounded-2xl bg-surface-subtle text-foreground-muted hover:text-foreground transition-all">
