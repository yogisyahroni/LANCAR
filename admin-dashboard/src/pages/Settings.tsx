...
export default function Settings() {
  ...
  return (
    <SettingsContent
      PREDEFINED_FLAGS={PREDEFINED_FLAGS}
      active={active}
      activeTab={activeTab}
      admins={admins}
      alert={alert}
      ...
      cat={cat}
      cn={cn}
      createFlagMutation={createFlagMutation}
      emergencyDisableMaps={emergencyDisableMaps}
      flag={flag}
      ...
      isLoadingMapsProvider={isLoadingMapsProvider}
      ...
      model={model}
      provider={provider}
      registerFlagForm={registerFlagForm}
      resolved={resolved}
      restoreOsmMaps={restoreOsmMaps}
      rule={rule}
      scope={scope}
      ...
      tab={tab}
      tabs={tabs}
      updateFlagMutation={updateFlagMutation}
      ...
      toggleMapsProviderMutation={toggleMapsProviderMutation}
      registerAdminMutation={registerAdminMutation}
      ...
      handleToggleMaps={handleToggleMaps}
