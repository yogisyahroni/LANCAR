...
export default function ExperienceScopeBar({ value, onChange, readOnly = false }: Props) {
  ...
  return (
    <section
      ...
      className="rounded-2xl border border-primary/25 bg-primary/10 p-4 shadow-lg shadow-primary/5"
    >
        ...
        <div className="grid w-full gap-3 sm:grid-cols-2 xl:w-auto xl:grid-cols-4">
          <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400">
            ...
            <input
              ...
              disabled={readOnly}
              className="mt-1 w-full min-w-32 rounded-xl border border-white/10 bg-black/20 px-3 py-2 text-xs font-bold normal-case tracking-normal text-zinc-100 disabled:opacity-60"
            />
          </label>
          <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400">
            Surface
            <select
              ...
              disabled={readOnly}
              className="mt-1 w-full min-w-48 rounded-xl border border-white/10 bg-black/20 px-3 py-2 text-xs font-bold normal-case tracking-normal text-zinc-100 disabled:opacity-60"
            >
          ...
          <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400">
            ...
            <input
              ...
              disabled={readOnly}
              className="mt-1 w-full min-w-28 rounded-xl border border-white/10 bg-black/20 px-3 py-2 text-xs font-bold normal-case tracking-normal text-zinc-100 disabled:opacity-60"
            />
          </label>
          <label className="text-[10px] font-black uppercase tracking-wider text-zinc-400">
            App version
