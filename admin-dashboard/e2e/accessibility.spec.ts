  ...
  await page.route('**/*', async (route) => {
    ...
    if (isApiRequest && (/\/api\/v1\/(admin|maps|experience)\//.test(pathname) || pathname === '/api/v1/payment-links')) {
      const responseByPath: Record<string, unknown> = {
        ...
        '/admin/finance/merchant-settlements': [
          {
            id: 'settlement-a11y-completed',
            order_id: 'order-a11y-completed',
            merchant_id: 'merchant-a11y-completed',
            status: 'completed',
            gross_item_price_idr: 100000,
            platform_fee: 5000,
            net_payout_idr: 95000,
            bank_name: 'Fixture Bank',
            bank_account_number: '1234567890',
            bank_account_holder: 'Settlement Fixture',
            created_at: '2026-09-10T00:00:00.000Z',
            pod_confirmed_at: '2026-09-10T01:00:00.000Z',
          },
          {
            id: 'settlement-a11y-processing',
            order_id: 'order-a11y-processing',
            merchant_id: 'merchant-a11y-processing',
            status: 'processing',
            gross_item_price_idr: 80000,
            platform_fee: 4000,
            net_payout_idr: 76000,
            bank_name: 'Fixture Bank',
            bank_account_number: '0987654321',
            bank_account_holder: 'Processing Fixture',
            created_at: '2026-09-10T00:00:00.000Z',
          },
          {
            id: 'settlement-a11y-failed',
            order_id: 'order-a11y-failed',
            merchant_id: 'merchant-a11y-failed',
            status: 'failed',
            failure_reason: 'Fixture bank rejected the payout.',
            gross_item_price_idr: 50000,
            platform_fee: 2500,
            net_payout_idr: 47500,
            created_at: '2026-09-10T00:00:00.000Z',
          },
        ],
        '/admin/pricing': [],
