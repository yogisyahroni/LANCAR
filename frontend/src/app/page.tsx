...
const services = [
  {
    ...
    accent: 'text-brand-emerald-300 bg-brand-emerald-500/10 border-brand-emerald-500/20',
  },
  {
    id: 'food',
    icon: Bike,
  ...
  return (
    <main className="min-h-screen bg-slate-950 text-white">
      ...
      <header className="sticky top-0 z-50 border-b border-white/5 bg-slate-950/80 backdrop-blur-md">
        <div className="mx-auto flex h-16 w-full max-w-6xl items-center justify-between px-5">
          ...
          <div className="flex items-center gap-2">
            ...
            <Link
              href="/daftar"
              className="rounded-xl bg-brand-emerald-500 px-4 py-2 text-sm font-black text-slate-950 transition-all hover:bg-brand-emerald-400"
            >
              Daftar
            </Link>
          </div>
      ...
      <section className="relative overflow-hidden">
        <div aria-hidden="true" className="pointer-events-none absolute -top-32 right-[-10%] h-[420px] w-[420px] rounded-full bg-brand-emerald-500/15 blur-[120px]" />
        <div className="mx-auto w-full max-w-6xl px-5 pb-16 pt-14 md:pt-24">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-brand-emerald-300">Logistik on-demand Indonesia</p>
          <h1 className="mt-4 max-w-3xl text-4xl font-black leading-tight tracking-tight md:text-6xl">
            TEMBUS. Semua kiriman,{' '}
            <span className="bg-gradient-to-r from-brand-emerald-300 to-brand-emerald-500 bg-clip-text text-transparent">
              tembus tanpa ribet.
            </span>
          </h1>
          ...
          <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center">
            <Link
              href="/orders/new"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-brand-emerald-500 px-7 py-4 text-base font-black text-slate-950 shadow-lg shadow-brand-emerald-500/25 transition-all hover:bg-brand-emerald-400 active:scale-[0.98]"
            >
              Kirim Sekarang
          ...
          <ul className="mt-8 flex flex-wrap gap-x-6 gap-y-2 text-xs text-slate-400">
            <li className="flex items-center gap-1.5">
              <Zap className="h-3.5 w-3.5 text-brand-emerald-400" /> Kurir terdekat otomatis
            </li>
            <li className="flex items-center gap-1.5">
              <ShieldCheck className="h-3.5 w-3.5 text-brand-emerald-400" /> Asuransi opsional
            </li>
            <li className="flex items-center gap-1.5">
              <Package className="h-3.5 w-3.5 text-brand-emerald-400" /> Resi publik bisa dilacak siapa saja
            </li>
          </ul>
        </div>
      </section>
            ...
            <tbody className="divide-y divide-white/5">
              {pricing.map((row) => (
                <tr key={row.service} className="transition-colors hover:bg-white/[0.03]">
                  ...
                  <td className="px-5 py-4 font-semibold text-brand-emerald-300">{row.price}</td>
      ...
      <section id="umkm" className="mx-auto w-full max-w-6xl scroll-mt-20 px-5 py-14">
        <div className="rounded-3xl border border-brand-emerald-500/20 bg-gradient-to-br from-brand-emerald-500/10 via-white/[0.02] to-transparent p-8 md:p-12">
          <p className="text-xs font-bold uppercase tracking-[0.3em] text-brand-emerald-300">Untuk UMKM</p>
          ...
          <Link
            href="/laporan"
            className="mt-6 inline-flex items-center justify-center gap-2 rounded-xl bg-brand-emerald-500 px-6 py-3.5 text-sm font-black text-slate-950 transition-all hover:bg-brand-emerald-400 active:scale-[0.98]"
          >
      ...
      <footer className="border-t border-white/5">
        <div className="mx-auto grid w-full max-w-6xl gap-8 px-5 py-12 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <nav aria-label="Tautan produk">
            <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400">Produk</h3>
          ...
          <nav aria-label="Bantuan">
            <h3 className="text-xs font-bold uppercase tracking-widest text-slate-400">Bantuan</h3>
            <ul className="mt-3 space-y-2 text-sm text-slate-300">
