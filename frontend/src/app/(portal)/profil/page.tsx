              ...
              <div className="p-6 rounded-2xl border border-border/40 bg-card/60 backdrop-blur-sm space-y-6">
                ...
                <div className="flex justify-end pt-2">
                  <button
                    ...
                    className="flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary/90 text-on-primary font-bold text-xs rounded-xl shadow-md shadow-primary/20 transition-all hover:scale-[1.02] active:scale-[0.98] disabled:opacity-60 cursor-pointer"
                  >
                    {isSavingBank ? (
                      <>
