...
// ErrCircuitProbeInFlight is returned while a half-open recovery probe is
// already running. This prevents a dependency outage from creating a probe
// stampede when the timeout expires.
