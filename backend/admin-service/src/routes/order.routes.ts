...
orderRoutes.get('/api/v1/customer/orders/:orderId/safety-center', requireMobileOrWebAuth, (req, res) => controllers.getCustomerSafetyCenter(req, res));
orderRoutes.get('/api/v1/customer/safety/emergency-contacts', requireMobileOrWebAuth, (req, res) => controllers.listCustomerEmergencyContacts(req, res));
orderRoutes.post('/api/v1/customer/safety/emergency-contacts', requireMobileOrWebAuth, requireIdempotencyKey('customer.safety_emergency_contact.create'), (req, res) => controllers.createCustomerEmergencyContact(req, res));
orderRoutes.delete('/api/v1/customer/safety/emergency-contacts/:id', requireMobileOrWebAuth, requireIdempotencyKey('customer.safety_emergency_contact.revoke'), (req, res) => controllers.revokeCustomerEmergencyContact(req, res));
orderRoutes.post('/api/v1/customer/orders/:orderId/safety-incidents', requireMobileOrWebAuth, requireIdempotencyKey('customer.safety_incident.create'), (req, res) => controllers.createCustomerSafetyIncident(req, res));
orderRoutes.post('/api/v1/customer/orders/:orderId/sos', requireMobileOrWebAuth, requireIdempotencyKey('customer.sos.trigger'), (req, res) => controllers.triggerCustomerSOS(req, res));
orderRoutes.post('/api/v1/customer/orders/:orderId/safety-share', requireMobileOrWebAuth, requireIdempotencyKey('customer.safety_share.create'), (req, res) => controllers.createCustomerSafetyShare(req, res));
orderRoutes.delete('/api/v1/customer/safety-share/:tokenId', requireMobileOrWebAuth, requireIdempotencyKey('customer.safety_share.revoke'), (req, res) => controllers.revokeCustomerSafetyShare(req, res));
orderRoutes.get('/api/v1/safety/share/:token', publicEndpointRateLimiter, (req, res) => controllers.getPublicSafetyShare(req, res));
...
orderRoutes.post('/api/v1/customer/orders/:id/package-photo', requireMobileOrWebAuth, ...secureUploadSingle('file', 'evidenceImage'), (req, res) => controllers.customerOrder.uploadPackagePhoto(req, res));
