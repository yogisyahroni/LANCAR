...
publicRoutes.get('/api/v1/logistics/check-tariff', (req, res) => controllers.paymentLink.checkTariff(req, res));
publicRoutes.get('/api/v1/logistics/locations', (req, res) => controllers.logisticsLocations.listCustomerLogisticsLocations(req, res));
publicRoutes.get('/api/v1/logistics/providers', (req, res) => controllers.listCustomerLogisticsProviders(req, res));
...
publicRoutes.get('/api/v1/compliance/policy', publicEndpointRateLimiter, (req, res) => controllers.getPublicCompliancePolicy(req, res));
publicRoutes.post('/api/v1/compliance/consents', requireMobileOrWebAuth, requireIdempotencyKey('compliance.consent'), (req, res) => controllers.createComplianceConsent(req, res));
publicRoutes.get('/api/v1/compliance/consents', requireMobileOrWebAuth, (req, res) => controllers.listComplianceConsents(req, res));
