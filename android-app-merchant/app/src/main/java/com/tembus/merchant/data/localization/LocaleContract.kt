...
/** Shared locale rules for merchant UI and user-facing formatting. */
...
object LocaleFormatters {
    ...
    private fun format(epochMillis: Long, languageTag: String?, timeZoneId: String?, style: Int): String {
        ...
        val formatter = when (style) { STYLE_DATE -> DateFormat.getDateInstance(DateFormat.MEDIUM, locale); STYLE_TIME -> DateFormat.getTimeInstance(DateFormat.SHORT, locale); else -> DateFormat.getDateTimeInstance(DateFormat.MEDIUM, DateFormat.SHORT, locale) }
