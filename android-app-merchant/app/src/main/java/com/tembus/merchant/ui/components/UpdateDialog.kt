...
/**
 * Shows a dialog notifying the merchant that a newer version is available.
 * Konsisten dengan dialog update customer/courier.
 */
@Composable
fun UpdateDialog(
    version: AppVersion,
                ...
                if (version.hardBlock || version.force) {
                    ...
                    Text(
                        text = "Pesanan aktif: ${if (version.recoveryAccess.activeOrder) "tetap dapat diakses" else "dibatasi"}. " +
                            ...
                            "Operasional baru: ${if (version.recoveryAccess.newTransactions) "tersedia" else "ditahan sampai update selesai"}.",
