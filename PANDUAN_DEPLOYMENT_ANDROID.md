...
**File Target:** `app/src/main/java/com/lancar/customer/data/api/LANCARApiService.kt`
*   **Ubah Variabel:** `BASE_URL`
*   **Aksi:** Ganti `"http://10.0.2.2:8080/api/v1/"` atau server staging menjadi `"https://api.lancar.com/api/v1/"`.

### 🚚 Aplikasi Kurir (`android-app`)
**File Target:** `app/src/main/java/com/lancar/courier/data/api/LANCARApiService.kt` *(atau setara)*
