    ...
    <main className="page-shell bg-[#f8fafc]">
          ...
          <div className="flex flex-col items-center justify-center text-center pt-8 lg:pt-16">
            <motion.div {...fadeUp()} className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-sm font-semibold text-[#9bd46f] mb-6 backdrop-blur-sm border border-white/10">
                ...
                <span>Pengiriman Super Cepat</span>
              </div>
              <h1 className="text-4xl font-black leading-[1.1] tracking-tight lg:text-5xl xl:text-6xl mb-6">
                Layanan <span className="text-[#9bd46f]">Same Day</span>
              </h1>
              <p className="mb-10 text-[15px] leading-relaxed text-white/80 lg:text-[17px]">
                Kirim barang Anda hari ini dan sampai di hari yang sama. Solusi paling tepat untuk kebutuhan pengiriman mendesak Anda dengan harga yang tetap hemat.
              </p>
      ...
      <section className="py-20 lg:py-28 px-6 sm:px-10 lg:px-16 xl:px-20 2xl:px-24">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp()} className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#071712] mb-4">Mengapa Memilih Same Day?</h2>
            <p className="text-[#64748b] max-w-2xl mx-auto">
              Layanan Same Day dari Tembus dirancang khusus untuk memberikan pengalaman pengiriman yang tak hanya cepat, tapi juga terjamin keamanannya.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { 
                icon: Clock, 
                title: "Tiba di Hari yang Sama", 
                desc: "Selama paket dikirim sebelum batas waktu penjemputan, kami garansi paket tiba di hari yang sama." 
              },
              { 
                icon: ShieldCheck, 
                title: "Asuransi Pengiriman", 
                desc: "Setiap paket yang dikirim menggunakan layanan Same Day otomatis terlindungi oleh asuransi." 
              },
              { 
                icon: MapPin, 
                title: "Live Tracking Akurat", 
                desc: "Pantau posisi kurir secara real-time dari saat paket diambil hingga sampai di tangan penerima." 
              },
              { 
                icon: CheckCircle2, 
                title: "Penanganan Khusus", 
                desc: "Paket ditangani dengan hati-hati untuk memastikan barang tetap utuh dan aman sampai tujuan." 
              }
            ].map((feature, i) => (
              <motion.div 
                key={i} 
      ...
      <section className="bg-[#eef6ed] py-20 px-6 sm:px-10 text-center">
        <motion.div {...fadeUp()} className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-black text-[#071712] mb-6">Punya Barang Mendesak?</h2>
          <p className="text-[#475569] mb-10 text-lg">
            Jangan tunda lagi. Pesan layanan Same Day sekarang dan nikmati kemudahan pengiriman cepat dalam genggaman Anda.
          </p>
          <a
            href={`${appUrl}/orders/new`}
