...
import { CheckCircle2, Map, ShieldCheck, WalletCards, Package } from "lucide-react";
    ...
    <main className="page-shell bg-[#f8fafc]">
          ...
          <div className="flex flex-col items-center justify-center text-center pt-8 lg:pt-16">
            <motion.div {...fadeUp()} className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-sm font-semibold text-[#9bd46f] mb-6 backdrop-blur-sm border border-white/10">
                ...
                <span>Ongkir Lebih Hemat, Kirim Tetap Tepat</span>
              </div>
              <h1 className="text-4xl font-black leading-[1.1] tracking-tight lg:text-5xl xl:text-6xl mb-6">
                Layanan <span className="text-[#9bd46f]">Reguler</span>
              </h1>
              <p className="mb-10 text-[15px] leading-relaxed text-white/80 lg:text-[17px]">
                Solusi logistik andalan untuk pengiriman antar kota atau antar pulau dengan estimasi waktu yang jelas dan tarif yang ramah di kantong. Pilihan cerdas untuk kiriman standar Anda.
              </p>
      ...
      <section className="py-20 lg:py-28 px-6 sm:px-10 lg:px-16 xl:px-20 2xl:px-24">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp()} className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#071712] mb-4">Keunggulan Layanan Reguler</h2>
            <p className="text-[#64748b] max-w-2xl mx-auto">
              Meski harganya hemat, layanan Reguler Tembus tetap mengedepankan keamanan dan ketepatan waktu.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { 
                ...
                desc: "Tarif kompetitif yang meringankan beban pengeluaran, sangat cocok untuk pengiriman tidak mendesak." 
              },
              { 
                icon: Map, 
                title: "Jangkauan Luas", 
                desc: "Didukung oleh jaringan hub yang tersebar luas, memungkinkan pengiriman ke hampir seluruh wilayah." 
              },
              { 
                icon: ShieldCheck, 
                title: "Tetap Aman Terlindungi", 
                desc: "Sistem logistik Tembus memastikan setiap pergerakan paket dilacak dan diasuransikan." 
              },
              { 
                icon: Package, 
                title: "Cocok untuk Semua Barang", 
                desc: "Kirim barang apa saja (kecuali barang terlarang) tanpa batasan spesifik seperti layanan instan." 
              }
            ].map((feature, i) => (
              <motion.div 
                key={i} 
      ...
      <section className="bg-[#eef6ed] py-20 px-6 sm:px-10 text-center">
        <motion.div {...fadeUp()} className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-black text-[#071712] mb-6">Punya Kiriman Rutin?</h2>
          <p className="text-[#475569] mb-10 text-lg">
            Tekan ongkos kirim Anda tanpa mengorbankan kualitas. Layanan Reguler Tembus selalu siap melayani kapan saja.
          </p>
          <a
            href={`${appUrl}/orders/new`}
