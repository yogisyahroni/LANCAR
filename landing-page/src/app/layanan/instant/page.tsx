...
import { CheckCircle2, MapPin, ShieldCheck, Zap } from "lucide-react";
    ...
    <main className="page-shell bg-[#f8fafc]">
          ...
          <div className="flex flex-col items-center justify-center text-center pt-8 lg:pt-16">
            <motion.div {...fadeUp()} className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-sm font-semibold text-[#9bd46f] mb-6 backdrop-blur-sm border border-white/10">
                ...
                <span>Pengiriman Prioritas Utama</span>
              </div>
              <h1 className="text-4xl font-black leading-[1.1] tracking-tight lg:text-5xl xl:text-6xl mb-6">
                Layanan <span className="text-[#9bd46f]">Instant</span>
              </h1>
              <p className="mb-10 text-[15px] leading-relaxed text-white/80 lg:text-[17px]">
                Butuh pengiriman mendesak dalam hitungan jam? Layanan Instant Tembus memastikan paket Anda langsung dijemput dan diantar ke tujuan tanpa transit!
              </p>
      ...
      <section className="py-20 lg:py-28 px-6 sm:px-10 lg:px-16 xl:px-20 2xl:px-24">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp()} className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#071712] mb-4">Mengapa Memilih Instant?</h2>
            <p className="text-[#64748b] max-w-2xl mx-auto">
              Layanan Instant menawarkan kecepatan tanpa kompromi. Kurir kami didedikasikan sepenuhnya untuk mengantar paket Anda secepat mungkin.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { 
                icon: Zap, 
                title: "Tiba Dalam Hitungan Jam", 
                desc: "Paket diantar langsung oleh kurir tanpa melewati hub atau proses transit lainnya. Cepat dan efisien." 
              },
              { 
                icon: ShieldCheck, 
                title: "Keamanan Ekstra", 
                desc: "Karena diantar langsung tanpa perantara, risiko paket hilang atau terselip hampir nol." 
              },
              { 
                icon: MapPin, 
                title: "Prioritas Penjemputan", 
                desc: "Begitu pesanan dibuat, kurir terdekat langsung menuju lokasi Anda untuk melakukan pickup." 
              },
              { 
                icon: CheckCircle2, 
                title: "Notifikasi Real-time", 
                desc: "Dapatkan pembaruan langsung dari sistem mengenai status terkini perjalanan paket Anda." 
              }
            ].map((feature, i) => (
              <motion.div 
                key={i} 
      ...
      <section className="bg-[#eef6ed] py-20 px-6 sm:px-10 text-center">
        <motion.div {...fadeUp()} className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-black text-[#071712] mb-6">Waktu Sangat Berharga?</h2>
          <p className="text-[#475569] mb-10 text-lg">
            Gunakan layanan Instant dari Tembus agar barang penting Anda segera tiba di lokasi dengan aman.
          </p>
          <a
            href={`${appUrl}/orders/new`}
