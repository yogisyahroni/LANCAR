...
import { Building2, Code2, Network, ShieldCheck, Users } from "lucide-react";
    ...
    <main className="page-shell bg-[#f8fafc]">
          ...
          <div className="flex flex-col items-center justify-center text-center pt-8 lg:pt-16">
            <motion.div {...fadeUp()} className="max-w-3xl">
              <div className="inline-flex items-center gap-2 rounded-full bg-white/10 px-3 py-1 text-sm font-semibold text-[#9bd46f] mb-6 backdrop-blur-sm border border-white/10">
                ...
                <span>Logistik Korporat & Enterprise</span>
              </div>
              <h1 className="text-4xl font-black leading-[1.1] tracking-tight lg:text-5xl xl:text-6xl mb-6">
                Layanan <span className="text-[#9bd46f]">Business (B2B)</span>
              </h1>
              <p className="mb-10 text-[15px] leading-relaxed text-white/80 lg:text-[17px]">
                Tingkatkan skala bisnis Anda dengan sistem distribusi logistik yang transparan, dapat diandalkan, dan terintegrasi penuh melalui API. Dirancang khusus untuk perusahaan yang mengutamakan profesionalisme.
              </p>
      ...
      <section className="py-20 lg:py-28 px-6 sm:px-10 lg:px-16 xl:px-20 2xl:px-24">
        <div className="max-w-4xl mx-auto">
          <motion.div {...fadeUp()} className="text-center mb-16">
            <h2 className="text-3xl font-black text-[#071712] mb-4">Partner Logistik Terbaik untuk Bisnis</h2>
            <p className="text-[#64748b] max-w-2xl mx-auto">
              Tidak sekadar mengirim barang, layanan Business kami bertindak sebagai perpanjangan dari divisi operasional perusahaan Anda.
            </p>
          </motion.div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            {[
              { 
                ...
                desc: "Hubungkan sistem ERP, website e-commerce, atau aplikasi kasir Anda langsung dengan sistem Tembus untuk automasi pengiriman." 
              },
              { 
                icon: Users, 
                title: "Dedicated Account Manager", 
                desc: "Dapatkan akses langsung ke Account Manager yang didedikasikan khusus untuk menangani seluruh kebutuhan logistik perusahaan Anda." 
              },
              { 
                icon: Network, 
                title: "Jaringan Distribusi B2B", 
                desc: "Kemampuan mengatur pengiriman secara bulk (massal), cross-docking, dan distribusi langsung ke berbagai cabang toko Anda." 
              },
              { 
                icon: ShieldCheck, 
                title: "Dashboard & Pelaporan Khusus", 
                desc: "Akses analitik mendalam, laporan tagihan tersentralisasi, dan metrik performa pengiriman secara real-time." 
              }
            ].map((feature, i) => (
              <motion.div 
                key={i} 
      ...
      <section className="bg-[#eef6ed] py-20 px-6 sm:px-10 text-center">
        <motion.div {...fadeUp()} className="max-w-2xl mx-auto">
          <h2 className="text-3xl font-black text-[#071712] mb-6">Siap Mengoptimalkan Operasional Bisnis Anda?</h2>
          <p className="text-[#475569] mb-10 text-lg">
            Diskusikan kebutuhan distribusi dan rantai pasok perusahaan Anda bersama tim ahli kami.
          </p>
          <a
            href={`${appUrl}/orders/new`}
