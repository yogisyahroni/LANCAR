...
@Serializable
data class RoadsideAdjustmentItemRequest(
...
@Serializable
data class RoadsideAdjustmentProposalRequest(
    @SerialName("order_id") val orderId: String,
    @SerialName("reason") val reason: String,
    @SerialName("items") val items: List<RoadsideAdjustmentItemRequest>
)

@Serializable
data class RoadsideAdjustmentResponse(
