package com.tembus.courier.data.device
...
class DeviceIdentityProvider @Inject constructor(
    ...
    private companion object {
        const val SECURE_PREFS_NAME = "secure_tembus_courier_device_identity"
        const val LEGACY_PREFS_NAME = "tembus_courier_device_identity"
