...
/**
 * Courier network policy: retry safe snapshots only. Order, payout, safety,
 * location and other mutations must be replayed by their durable/idempotent
 * queue, never by a transparent HTTP retry.
 */
