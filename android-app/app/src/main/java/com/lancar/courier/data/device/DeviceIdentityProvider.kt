package com.lancar.courier.data.device
...
class DeviceIdentityProvider @Inject constructor(
    ...
    private companion object {
        const val SECURE_PREFS_NAME = "secure_lancar_courier_device_identity"
        const val LEGACY_PREFS_NAME = "lancar_courier_device_identity"
