package com.lancar.courier.ui.components
...
fun UpdateDialog(
    ...
    AlertDialog(
        ...
        text = { 
            Text(
                text = "A new version of LANCAR Courier (${version.name}) is available. Please update to continue enjoying the best experience."
            ) 
        },
        confirmButton = {
            Button(
