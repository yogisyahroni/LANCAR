...
import com.lancar.customer.data.api.ApiClient
...
class NotificationReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        when (action) {
            ...
            ACTION_ACCEPT -> {
                ...
                val mainIntent = Intent(context, com.lancar.customer.ui.MainActivity::class.java).apply {
    ...
    companion object {
        ...
        const val ACTION_DISMISS = "com.lancar.customer.ACTION_DISMISS"
        const val ACTION_ACCEPT = "com.lancar.customer.ACTION_ACCEPT"
