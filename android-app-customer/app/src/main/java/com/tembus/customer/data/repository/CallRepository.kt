...
import com.tembus.customer.data.model.CreateCallRequest
import com.tembus.customer.data.model.EndCallRequest
import com.tembus.customer.data.model.JoinCallRequest
import com.tembus.customer.data.model.ReadReceiptRequest
...
class CallRepository @Inject constructor(
    ...
    fun createCourierCall(orderId: String): Flow<Result<CallSession>> = flow {
        try {
            val response = apiService.createOrderCall(orderId, CreateCallRequest(targetType = "courier"))
