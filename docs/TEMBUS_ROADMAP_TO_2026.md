...
| 1 | Split orders/[id]/page.tsx & OnDemandOrderForm.tsx | 🟡 PARTIAL (1530→1220 + orderDetailTypes.ts/orderDetailUtils.ts/RouteSnapshotPanel.tsx; section extraction pending) |
