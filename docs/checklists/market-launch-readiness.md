...
- Staging CI: run `34413492887` for commit `5bb8a3d1` — repository verification, migration, security, container-audit, image build/push and evidence gate jobs PASS. Deployment guard reported `STAGING_SSH_HOST` missing, so `deployed=false`; browser E2E and k6 jobs were skipped.
