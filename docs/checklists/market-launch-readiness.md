...
- Staging CI: run `34416282120` for commit `0bf9cbe0` — repository verification, migration, security, container-audit, image build/push and evidence gate jobs PASS. Deployment guard reported `STAGING_SSH_HOST` missing, so `deployed=false`; browser E2E and k6 jobs were skipped.
