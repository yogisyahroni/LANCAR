...
| --- | --- | --- | --- | --- | --- |
| Customer registered route inventory (27 routes) | PASS — 27/27 at 320px | PASS — 27/27 at 640px CSS equivalent | NOT_RUN | N/A | PASS — body remains inside viewport; no page errors | PARTIAL |
| `/` and public auth | PASS — included in Customer 27/27 inventory | PASS — included in Customer 27/27 inventory | NOT_RUN | N/A | PASS — primary control stays inside viewport | PARTIAL |
| Portal navigation, order creation, history, payment, profile and operational pages | PASS — included in Customer 27/27 inventory | PASS — included in Customer 27/27 inventory | NOT_RUN | N/A | PASS — shell remains inside viewport | PARTIAL |
| Public tracking and checkout forms | PASS — included in Customer 27/27 inventory | PASS — included in Customer 27/27 inventory | NOT_RUN | N/A | PASS — route remains inside viewport | PARTIAL |
