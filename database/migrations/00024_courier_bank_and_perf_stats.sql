-- +goose Up
-- Migration 00024: Add bank account info and performance stats to courier_profiles
-- Required for: enterprise payout disbursement and real relay score calculation
...
-- These are periodically updated by the analytics worker
ALTER TABLE courier_profiles
...
-- Index for payout batch processing
...
DROP INDEX IF EXISTS idx_courier_bank_code;
